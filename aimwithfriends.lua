if game.GameId == 113491250 then
    ...
    local pidorxxx1488 = MainSector:CreateDropDown("Friend list:)", {""}, HyperEscape.AimBot.friendlist, true, function(AHS) HyperEscape.AimBot.friendlist = AHS; end);
    task.spawn(function() while wait(1) do for i,v in pairs(game.Players:GetPlayers()) do pidorxxx1488:Remove(v.Name); pidorxxx1488:Add(v.Name); end; end; end)
